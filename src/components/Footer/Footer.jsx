    ...
    <div className="footer">
        ...
        <div className="compte space">
            ...
            <div className="commu">
              ...
              <a  href=""> <BsTelegram className='commu-n'/> </a>
             <a href=""> <BsTelegram className='commu-n'/> </a>
            <a href=""> <BsTwitter className='commu-n'/></a>
            <a href=""><SiDiscord className='commu-n'/></a>
            </div>
            <div className="tit2">Support</div>
            <div className="email"><CgMail className='comail'/><span className='suppor'>support@foxfarmtoken.com</span></div>
            <a href=""> <BsTelegram className='commu-n'/><span className="teleg">Telegram</span></a>
